								...
								<div class="row">
									...
									<div class="col-lg-4 col-md-6 col-sm-12">
										<div class="basic-info-item">
											...
											<div class="info-content">
												<p>xyz ,</p>
												<h3>university Road Peshawar</h3>
											</div>
										</div>
									</div>
									<!-- basic-info-item - end -->
									...
									<div class="col-lg-4 col-md-6 col-sm-12">
										<div class="basic-info-item">
											...
											<div class="info-content">
												<p><a href="#!">contact@webifyevent.com</a></p>
												<h3><a href="#!">info@webifyevent.com</a></h3>
											</div>
										</div>
									</div>
									<!-- basic-info-item - end -->
									...
									<div class="col-lg-4 col-md-6 col-sm-12">
										<div class="basic-info-item">
											...
											<div class="info-content">
												<p><a href="#!">+92 311 0000 000</a></p>
												<h3><a href="#!">+92 300 0000 000</a></h3>
											</div>
										</div>
									</div>
									<!-- basic-info-item - end -->
					...
					<div class="row">
						...
						<div class="col-lg-7 col-md-12 col-sm-12">
							<div class="copyright-text">
								<p class="m-0 text-light">©2023 <a href="#!" class="site-link">webifyevent.com</a> all right reserved, made with <i class="fas fa-heart"></i> by <a href="#!" class="author-link"><strong>Zulfiqar Ali Zeb</strong></a></p>
							</div>
						</div>
						<!-- copyright-text - end -->
