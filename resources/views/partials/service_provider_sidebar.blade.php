    ...
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <a class="nav-link" href="{{route('serviceprovider.dashboard')}}">
                ...
                <div class="collapse" id="collapseService" aria-labelledby="headingfour" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">                        
                        <a class="nav-link" href="{{route('serviceprovider.service.create')}}">Create Service</a>
                        <a class="nav-link" href="{{route('serviceprovider.service.index')}}">All Service</a>
                    </nav>
                </div>
                ...
                <div class="collapse" id="collapsebooking" aria-labelledby="headingfour" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">                        
                        <a class="nav-link" href="{{route('serviceprovider.booking')}}">All Booking</a>
