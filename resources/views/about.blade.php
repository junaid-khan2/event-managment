						...
						<div class="row justify-content-center">
							<div class="col-lg-6 col-md-12 col-sm-12">
								...
								<div class="breadcrumb-title text-center mb-50">
									...
									<h2 class="big-title"><strong>about</strong> Webify Event</h2>
								</div>
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-12 col-sm-12">
						<div class="section-title text-left mb-50 sr-fade1">
							<small class="sub-title">we are Webify Event</small>
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-12 col-sm-12">
						...
						<div class="section-title text-left mb-80 sr-fade1">
							<small class="sub-title">Webify Event awaed</small>
				...
				<div class="row">
					<div class="col-lg-6">
						<div class="section-title mb-50 sr-fade1">
							...
							<h2 class="big-title">Webify Event <strong>Advantages</strong></h2>
						</div>
					</div>
				...
				<div id="testimonial5-carousel" class="testimonial5-carousel sr-fade2 owl-carousel owl-theme">
					...
					<div class="item text-center">
						...
						<p class="clients-comment">
							“Bring people together, or turn your passion into a business. Webify Event gives you everything you need to host your best event yet. lorem ipsum diamet. Bring people together, or turn your passion into a business. Webify Event gives you everything you need to host your best event yet.”
						</p>
									...
									<div class="col-lg-6">
										<div class="speaker-content">
											...
											<div class="section-title text-left mb-50">
												<span class="line-style"></span>
												<small class="sub-title">Webify Event staffs</small>
						...
						<div class="slider-nav">
							<div class="item">
								<div class="item-content">
									...
									<span class="sub-title">Webify Event Speaker</span>
								</div>
							</div>
